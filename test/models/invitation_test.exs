defmodule Classlab.InvitationTest do
  ...
  @valid_attrs %{completed_at: %{day: 17, hour: 14, min: 0, month: 4, sec: 0, year: 2010}, email: "some content", first_name: "some content", invitation_token: "some content", last_name: "some content"}
  @invalid_attrs %{}
